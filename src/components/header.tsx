...
const Header = () => {
  return (
    <header className="w-full flex items-center justify-between p-4 xs:p-4 sm:p-4 px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16 max-w-[1920px] mx-auto relative">
      {/* Degradado descendente de negro a transparente */}
      ...
      <a 
        ...
        className="hidden sm:flex px-2 py-1.5 xs:px-3 xs:py-2 sm:px-4 sm:py-2 md:px-6 text-2xl font-bold text-center uppercase text-white items-center gap-2 z-10"
      >
      ...
      {/* Logo centrado */}
      <a href="/" className="flex items-center gap-1 xs:gap-2 sm:gap-3 md:gap-4 z-10">
        <WidgetLogo />
      </a>
